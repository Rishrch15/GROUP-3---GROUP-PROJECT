...
public class Success extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnApprove.setOnClickListener(v -> {
            ...
            if (json != null) {
                // We already have the JSON string in `json`, no need to serialize again
                Intent intent = new Intent(Success.this, DetailActivity.class);
                intent.putExtra("request_json", json);
                startActivity(intent);
